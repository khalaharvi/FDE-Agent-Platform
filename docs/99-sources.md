...
plugin — found three more, all of them older than the work that surfaced them.
Two are fixed. The third is recorded open rather than quietly fixed, because
closing it changes a model-facing tool signature and that is not a thing to
